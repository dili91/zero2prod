...
async fn subscribe_returns_a_200_for_valid_form_data() {
    ...
    assert_eq!(saved.name, "Andrea Di Lisio");
    assert_eq!(saved.email, "andrea@dilis.io");
}
...
async fn spawn_app() -> TestApp {
    ...
    // Overriding the database name with a random string to spin up
    // a new isolated database each time
